      ...
      <div class="confirmacion-container">
        ...
        <div class="summary">
          ...
          <div v-if="compraData.entradas && Object.values(compraData.entradas).some(qty => qty > 0)">
            ...
            <ul>
              <li v-for="(quantity, type) in compraData.entradas" :key="type" style="list-style-type: none; margin-left: 1rem;">
        ...
        <div class="confirmacion-footer">
          <button @click="$emit('close')" class="btn-primary">Finalizar</button>
        </div>
      </div>
    </div>
  </template>
